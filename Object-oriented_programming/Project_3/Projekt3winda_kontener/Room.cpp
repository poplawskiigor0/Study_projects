...
Room::Room(int floor, int windows_count, bool clear, string function, SmartBox<Human> passengers, SkyScraper building){
    #ifdef _DEBUG
...
bool Room::operator==(const Room &e){
    if(this==&e)
        return true;
    if(    m_window_count==e.m_window_count &&
           m_window_clear==e.m_window_clear &&
           m_function==e.m_function) return true;
    return false;
}
